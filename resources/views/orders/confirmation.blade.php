    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                ...
                <div class="space-y-8">
                    ...
                    <div class="relative flex items-start">
                        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-green-500 text-white font-bold z-10">
                    ...
                    <!-- Processing -->
                    <div class="relative flex items-start">
                        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-blue-500 text-white font-bold z-10 animate-pulse">
                    ...
                    <!-- Shipped -->
                    <div class="relative flex items-start">
                        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-gray-300 text-gray-600 font-bold z-10">
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-gray-600">
                        We've sent a confirmation email to <strong>{{ $order->email ?? 'your email' }}</strong> with your order details and tracking information.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 text-center pb-8">
            ...
            <div class="flex justify-center space-x-4">
                <button class="w-12 h-12 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition duration-200">
                    <i class="fab fa-facebook-f"></i>
                </button>
                <button class="w-12 h-12 bg-blue-400 text-white rounded-full hover:bg-blue-500 transition duration-200">
                    <i class="fab fa-twitter"></i>
                </button>
                <button class="w-12 h-12 bg-pink-600 text-white rounded-full hover:bg-pink-700 transition duration-200">
                    <i class="fab fa-instagram"></i>
                </button>
                <button class="w-12 h-12 bg-green-600 text-white rounded-full hover:bg-green-700 transition duration-200">
